...
namespace SetLyric {
    public partial class Index : Form {
        ...
        private void TextBox_ChangeSize( object sender, MouseEventArgs e ) {
            ...
            FocusOnTextarea( tmptextbox.Tag.ToString() );
        }
        ...
        private void FocusOnTextarea( string tag ) {
            if( tag == "O" ) {
                TLP_2.ColumnStyles[ 0 ].Width = 90F;
                TLP_2.ColumnStyles[ 2 ].Width = 10F;
            } else if( tag == "C" ) {
                TLP_2.ColumnStyles[ 0 ].Width = 10F;
                TLP_2.ColumnStyles[ 2 ].Width = 90F;
            }
        }
